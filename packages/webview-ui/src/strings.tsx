...
const zh = {
  ...
  closeAll: '关闭全部',
  closeAllHint: '从列表移除全部变更（不改动文件）',
  collapseChanges: '折叠变更列表',
  expandChanges: '展开变更列表',
  keepAll: '全部保留',
  stateKept: '已保留',
  stateReverted: '已还原',
  stateRejected: '已拒绝',
...
const en: Strings = {
  ...
  closeAll: 'Close all',
  closeAllHint: 'Remove every change from the list (files are left as they are)',
  collapseChanges: 'Collapse the changes list',
  expandChanges: 'Expand the changes list',
  keepAll: 'Keep all',
  stateKept: 'kept',
